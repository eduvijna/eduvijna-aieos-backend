...
[[ "$head_rev" == "tosd070001" ]] || fail "expected head tosd070001 after upgrade, got ${head_rev}"
infra_revoke_and_baseline
...
run_alembic_as_migrator upgrade head
head_rev="$(psql_query -c "SELECT version_num FROM alembic_version")"
[[ "$head_rev" == "tosd070001" ]] || fail "expected tosd070001 after re-upgrade, got ${head_rev}"
infra_revoke_and_baseline
