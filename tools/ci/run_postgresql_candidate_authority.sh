...
[[ "$head_rev" == "tosd030002" ]] || fail "expected head tosd030002 after upgrade, got ${head_rev}"
infra_revoke_and_baseline
...
run_alembic_as_migrator upgrade head
head_rev="$(psql_query -c "SELECT version_num FROM alembic_version")"
[[ "$head_rev" == "tosd030002" ]] || fail "expected tosd030002 after re-upgrade, got ${head_rev}"
infra_revoke_and_baseline
