...
[[ "$head_rev" == "tosd080002" ]] || fail "expected head tosd080002 after upgrade, got ${head_rev}"
infra_revoke_and_baseline
...
run_alembic_as_migrator upgrade head
head_rev="$(psql_query -c "SELECT version_num FROM alembic_version")"
[[ "$head_rev" == "tosd080002" ]] || fail "expected tosd080002 after re-upgrade, got ${head_rev}"
infra_revoke_and_baseline
