...
[[ "$head_rev" == "tosd090001" ]] || fail "expected head tosd090001 after upgrade, got ${head_rev}"
infra_revoke_and_baseline
...
run_alembic_as_migrator upgrade head
head_rev="$(psql_query -c "SELECT version_num FROM alembic_version")"
[[ "$head_rev" == "tosd090001" ]] || fail "expected tosd090001 after re-upgrade, got ${head_rev}"
infra_revoke_and_baseline
