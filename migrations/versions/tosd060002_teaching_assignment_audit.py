"""TOS-DEV06-I03R1 TeachingAssignment security audit constraint extension.

Revision ID: tosd060002
Revises: tosd060001
Create Date: 2026-09-01

Extends security.audit_records CHECK constraints for teaching.assignment.* actions.
Does not create teaching.assignments or modify Content/Asset/outbox/idempotency schema.

Executes under AIEOS_SECURITY_SCHEMA_OWNER_ROLE, then restores
AIEOS_SCHEMA_OWNER_ROLE. Downgrade fails closed when Teaching audit evidence exists.
"""
...
revision: str = "tosd060002"
down_revision: str | None = "tosd060001"
...
_TEACHING_EVIDENCE_BLOCKED = (
    "TOS-DEV06-I03R1 downgrade refused: Teaching security audit evidence exists "
...
DOWNGRADE_RESTORE_ACTIONS_SQL = (
    _CONTENT_ACTIONS_SQL.rstrip() + "," + _ASSET_ACTIONS_SQL
)
