...
class TestGenerationRunPostgres:
    ...
    def test_idempotency_unique_and_status_transitions(
        ...
        with factory(tenant_id) as uow:
            ...
            assert uow.generation_runs.update(validated, expected_revision=0)
            uow.commit()
        ...
        with factory(tenant_id) as uow:
            ...
            assert uow.generation_runs.update(succeeded, expected_revision=1)
            uow.commit()
        ...
        with factory(tenant_id) as uow:
            ...
            assert found.aggregate_revision == 2
