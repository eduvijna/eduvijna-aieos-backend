...
class SqlAlchemyIdempotencyRepository:
    ...
    def get(self, scope: IdempotencyScope) -> IdempotencyOutcome | None:
        ...
        return IdempotencyOutcome(
            ...
            result_review_decision_id=row["result_review_decision_id"],
        ...
        try:
            self._connection.execute(
                idempotency_records_table.insert().values(
                    ...
                    result_review_decision_id=outcome.result_review_decision_id,
                    result_publication_id=outcome.result_publication_id,
