...
from aieos.domains.teaching.application.errors import (
    ...
    TeachingExecutionObservationNotFound,
    TeachingExecutionObservationRevisionConflict,
...
_TEACHING_PROBLEMS: dict[type[TeachingApplicationError], tuple[int, str, str, str]] = {
    ...
    TeachingWorkCapabilityForbidden: (
        403,
        "teaching_work_capability_forbidden",
        "Teaching Work capability denied",
        "The request is not authorized for this Teaching Work operation",
    ),
    RemediationAssessmentNotFound: (
        404,
    ...
    RemediationAssessmentNotRecorded: (
        ...
        "Only a RECORDED ClassroomAssessment may initiate remediation",
    ),
    RemediationAssessmentRevisionConflict: (
        412,
        "resource_revision_conflict",
        "Resource revision conflict",
        "Expected ClassroomAssessment revision does not match",
    ),
    RemediationCompositionConflict: (
        409,
        "assessment_composition_conflict",
        "Assessment composition conflict",
        "ClassroomAssessment Teaching composition is not coherent",
    ),
    ...
    ClassRefNotAssignable: (
        ...
        "ClassRef not assignable",
        "The requested ClassRef is not currently assignable for this teacher",
    ),
    ContentNotFoundForAssignment: (
        404,
        "content_not_found",
        "Content not found",
        "The requested Content is not visible for assignment",
    ),
    ContentVersionMismatch: (
        409,
        "content_version_mismatch",
        "Content version mismatch",
        "The requested ContentVersion is not the published exact version",
    ),
    ContentNotEligibleForAssignment: (
        422,
        "content_not_eligible_for_assignment",
        "Content not eligible for assignment",
        "The requested Content is not learner-assignable for classroom assignment",
    ),
    TeachingAssignmentNotFound: (
        404,
        "teaching_assignment_not_found",
        "TeachingAssignment not found",
        "The requested TeachingAssignment is not visible",
    ),
    TeachingAssignmentForbidden: (
        403,
        "teaching_assignment_forbidden",
        "TeachingAssignment forbidden",
        "The TeachingAssignment is owned by a different teacher",
    ),
    TeachingAssignmentNotActive: (
        409,
        "teaching_assignment_not_active",
        "TeachingAssignment not active",
        "The TeachingAssignment is not ACTIVE",
    ),
    InvalidTeachingAssignmentRequest: (
        422,
        "invalid_teaching_assignment_request",
        "Invalid TeachingAssignment request",
        "The TeachingAssignment request failed validation",
    ),
    TeachingExecutionNotFound: (
        404,
        "teaching_execution_not_found",
        "TeachingExecution not found",
        "The requested TeachingExecution is not visible",
    ),
    TeachingExecutionForbidden: (
        403,
        "teaching_execution_forbidden",
        "TeachingExecution forbidden",
        "The TeachingExecution is owned by a different teacher",
    ),
    TeachingExecutionNotInProgress: (
        409,
        "teaching_execution_not_in_progress",
        "TeachingExecution not in progress",
        "The TeachingExecution is not IN_PROGRESS",
    ),
    InvalidTeachingExecutionRequest: (
        422,
        "invalid_teaching_execution_request",
        "Invalid TeachingExecution request",
        "The TeachingExecution request failed validation",
    ),
    ExecutionContentBindingRejected: (
        422,
        "execution_content_binding_rejected",
        "Execution content binding rejected",
        "A TeachingExecution content binding failed exact-version or Work artifact checks",
    ),
    TeachingExecutionObservationNotFound: (
        404,
        "teaching_execution_observation_not_found",
        "TeachingExecutionObservation not found",
        "The requested TeachingExecutionObservation is not visible",
    ),
    TeachingExecutionObservationRevisionConflict: (
        412,
        "teaching_execution_observation_revision_conflict",
        "TeachingExecutionObservation revision conflict",
    ...
    UnsupportedObservationKind: (
        ...
        "The requested observation_kind is not supported",
    ),
    SourceWorkNotFound: (
        404,
        "source_work_not_found",
        "Source TeachingWork not found",
        "The optional source TeachingWork is not visible",
    ),
    SourceWorkForbidden: (
        403,
        "source_work_forbidden",
        "Source TeachingWork forbidden",
        "The optional source TeachingWork is owned by a different teacher",
    ),
}
